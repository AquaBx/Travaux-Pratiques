...
public:
	...
	/// <param name="color">The color.</param>
	void drawPixel(const Vector2<float>& coordinates, const Color& color);
	...
	/// <param name="color">The color.</param>
	void drawCircle(const Vector2<float>& center, float radius, const Color& color);
	...
	/// <param name="color">The color.</param>
	void drawString(const Vector2<float>& position, const std::string& str,
